package com.pdmi_samsung.android.visual_preferences.mtcnn
...
class MTCNNModel(val tensorFlowInferenceInterface: TensorFlowInferenceInterface)  {
    companion object {
        fun create (assetManager : AssetManager) : MTCNNModel {
            return MTCNNModel(TensorFlowInferenceInterface(assetManager, "file:///android_asset/mtcnn_freezed_model.pb"))
        }
    }
