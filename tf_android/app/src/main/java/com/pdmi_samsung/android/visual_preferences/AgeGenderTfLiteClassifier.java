 ...
 */
public class AgeGenderTfLiteClassifier extends TfLiteClassifier{

    /** Tag for the {@link Log}. */
    private static final String TAG = "AgeGenderTfLite";

    private static final String MODEL_FILE =
            "age_gender_ethnicity_224_deep-03-0.13-0.97-0.88.tflite";

    public AgeGenderTfLiteClassifier(final AssetManager assetManager) throws IOException {
    ...
    protected ClassifierResult getResults(float[][][] outputs) {
        ...
        //age
        final float[] age_features = outputs[1][0];
        int max_index = 2;
        ...
        float gender = outputs[2][0][0];
        final float[] ethnicity_scores = outputs[3][0];
